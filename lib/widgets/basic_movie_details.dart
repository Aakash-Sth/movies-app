  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        Stack(
          children: [
            SizedBox(height: screenSize.height * 0.346),
            TopImageStack(backdropUrl: movie.backdropUrl, rating: movie.rating.toStringAsFixed(1)),
            Positioned(
              bottom: 0,
              left: 29,
              child: Row(
              ...
              return Row(
                ...
                children: datas
                    .map(
                      (data) => Row(
                        children: [
                          SvgPicture.asset(data["icon"], color: Colors.grey),
